...
public class UpdatePathServlet extends HttpServlet {
    ...
    // 上传文件存储目录
    private static final String UPLOAD_DIRECTORY = "tximg";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            iUserinfoDao.updatePath(path,userInfo.getUserId());
        ...
        getServletContext().getRequestDispatcher("/mingzilongqueryUserServlet").forward(
                request, response);
    }
